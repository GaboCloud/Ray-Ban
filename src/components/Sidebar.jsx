export function Sidebar({ children, isOpen, onClickClose }) {
  return (
    <div>
      <div
        className={`fixed right-0 top-0 z-50 h-full w-full transform bg-white/40 backdrop-blur-2xl p-5 shadow-2xl shadow-black/50 transition duration-300 md:w-[50%] lg:w-[35%] ${
